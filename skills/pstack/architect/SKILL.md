...
metadata:
  ...
  upstream-path: "pstack/skills/architect/SKILL.md"
  client-only:
...
Use your configured `architect runners` list (one runner per entry), or your harness's default model when no list is configured.
