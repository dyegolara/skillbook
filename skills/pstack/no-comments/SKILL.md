...
metadata:
  ...
  upstream-path: "pstack/skills/no-comments/SKILL.md"
  client-only:
...
1. Use your harness's subagent/task mechanism if it has one (for example a named agent); otherwise run the Comment Sicko review inline following [`../agents/comment-sicko.md`](../agents/comment-sicko.md). Pass the scope. Do not restate its rules.
