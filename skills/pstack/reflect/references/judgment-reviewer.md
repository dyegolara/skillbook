...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.agents/skills/`, or installed-plugin paths under your harness's plugins directory, with the legacy `.cursor/skills/`, `~/.cursor/skills/`, and `~/.cursor/plugins/` locations as fallbacks)
